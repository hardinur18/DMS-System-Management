...
const defaultRolePermissions: Record<string, string[]> = {
  ...
  "ROLE-FIN": ["dashboard.view", "master_data.view", "employees.view", "attendance.view", "biofinger.view", "overtime.view", "overtime.review", "payroll.view", "payroll.process", "cash_advance.manage", "audit_logs.view"],
  "ROLE-SPV": ["dashboard.view", "users.view", "employees.view", "attendance.view", "attendance.review", "biofinger.view", "overtime.view", "master_data.view"],
  "ROLE-ADMIN": ["dashboard.view", "users.view", "users.create", "master_data.view", "master_data.manage", "employees.view", "employees.manage", "attendance.view", "attendance.review", "biofinger.view", "biofinger.manage", "audit_logs.view"],
  "ROLE-VIEWER": ["dashboard.view", "users.view", "master_data.view", "employees.view", "attendance.view", "biofinger.view", "payroll.view"],
}
